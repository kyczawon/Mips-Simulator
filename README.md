Computer Architecture II Coursework
==========================

Our task was to develop a MIPS CPU simulator, which can accurately execute
MIPS-1 big-endian binaries. We also had to develop a testbench
which was able to test the MIPS simulator to work out whether it
is correct.

## Authors

* **Leszek Nowaczyk** - [kyczawon](https://github.com/kyczawon)
* **Alesandro Serena** - [alexander3605](https://github.com/alexander3605)

Special thanks to our Computer Architecture II professor:
